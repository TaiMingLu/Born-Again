...
def compute_topk_metrics(outputs, labels, topk=(1, 5)):
    """Return top-k accuracies for the provided logits and labels."""
    if outputs.ndim == 1:
    ...
    for k in topk:
        ...
        res.append(correct_k / labels.size(0))
    return res
...
def evaluate(model, loss_fn, dataloader, metrics, params):
    ...
    with torch.no_grad():
        for data_batch, labels_batch in dataloader:
            ...
            summary_batch['test_err5'] = err5_pct
