#!/bin/bash
#SBATCH --job-name=vanilla-densenet90-60
#SBATCH --nodes=1
...
#SBATCH --output=/u/tl0463/scratch/Distillation/BAN/run/out/vanilla_densenet90_60_cifar100.out
...
RUN_NAME="vanilla_densenet90_60_cifar100"
...
CONFIG_PATH=/u/tl0463/scratch/Distillation/BAN/knowledge-distillation-pytorch/experiments/ban/vanilla_densenet90_60_cifar100/vanilla_densenet90_60_cifar100.json
...
srun python -u train.py \
  ...
  --experiment ${RUN_NAME} \
  --seed 42 \
  --wandb_tags vanilla cifar100 densenet90_60 epoch200
